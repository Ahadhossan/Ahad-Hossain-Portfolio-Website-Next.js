...
const Article = ({ img, title, date, link }) => {
  return (
    <motion.li
      ...
      viewport={{ once: true }}
      className="w-full p-4 py-6 my-4 flex items-center justify-between text-dark bg-light first:mt-0 border border-solid border-dark rounded-xl relative border-r-4 border-b-4 dark:border-light dark:bg-dark dark:text-light sm:flex-col"
    >
...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
  return (
    <li className="col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-xl relative dark:bg-dark dark:border-light">
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Ahad | Articles Page</title>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:text-light">
        <Layout className="pt-16">
          ...
          <ul>
            ...
            />
            <Article
              title="uild A Fabulous Todo List App With React, Redux And Framer-Motion"
              date="June 14, 2024"
              link="/"
              img={article6}
            />
